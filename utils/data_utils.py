...
cifar10_dict = dsDict(CIFAR10, (0.4914, 0.4822, 0.4465), (0.2470, 0.2435, 0.2616))
cifar100_dict = dsDict(CIFAR100, (0.5071, 0.4865, 0.4409), (0.2673, 0.2564, 0.2762))
...
def load_dataloader(args, dataset_name, dataroot, is_iid=1, dataloader_num=1):
	...
	if is_iid == 1 and dataloader_num == 1:
		train_loader = torch.utils.data.DataLoader(ds.dataset(root=dataroot, transform=ds.train_transform, train=True, download=True),
